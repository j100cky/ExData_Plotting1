...
#making plot 4.
#first modify the number of plots in one window
par(mfrow = c(2,2))
#first plot
with(data, plot(Global_active_power~datetime, type = "l", ylab = "Global Active Power", xlab = NA))
#second plot
